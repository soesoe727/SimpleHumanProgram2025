...
class  MotionPlaybackApp2 : public GLUTBaseApp
{
  ...
  public:
	...
	//タイムラインのパターン毎読み込み
	void  PatternTimeline( Timeline * timeline, Motion & motion, Motion & motion2, float curr_frame, DTWinformation2 * DTW);
